$(document).ready(function() {
  ...
  var searchtype;
  var value;
  if (url.indexOf("?category=") !== -1 || url.indexOf("?location=") !== -1 || url.indexOf("?date=") !== -1) {
    searchtype = url.split("=")[0];
    value = url.split("=")[1];
    getPosts(searchtype.substr(1),value);
  }
  ...
  function getPosts(st,val) {
    searchtype = st || "";
    value = val || "";
    if (searchtype) {
      searchtype = "/" + searchtype + "/" ;
    }
    $.get("/api/events" + searchtype + value, function(data) {
